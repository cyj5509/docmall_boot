								...
								<c:forEach items="${cart_list}" var="cartDTO">
									<tr>
										...
										<td><img width="50%" height="50"
												src="/user/product/imageDisplay?dateFolderName=${cartDTO.pro_up_folder}&fileName=${cartDTO.pro_img}"
												alt="">
										</td>
										...
										<td><span class="unitTotalPrice" id="unitTotalPrice">${cartDTO.pro_price *
												cartDTO.cart_amount}</span></td>
