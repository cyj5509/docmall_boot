...
//	@Resource(name = "uploadPath") // servlet-context.xml 의 uploadPath bean 이름 참조를 해야 함.
	@Value("${file.dir}") // application.properties 파일의 설정 참조
	private String uploadPath;
	
	// CKEditor에서 사용되는 업로드 폴더경로
//	@Resource(name = "uploadCKPath") // servlet-context.xml 의 bean이름 참조를 해야 함.
	@Value("${file.ckdir}") // application.properties 파일의 설정 참조
